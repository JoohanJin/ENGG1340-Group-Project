...
void character_storing(string job, int skill_number, Skill s[4]) {
	if (job == "Knight") {
		...
		s[2].explanation = "Wizard's special attack, summon hell fire from the hell. 8000 damage";
		s[3].name = "Lightning Bolt"; s[3].damage = 15000; s[3].healing = 0;
		s[3].explanation = "Wizard's ultimate attack, summons lightning from the clouds. 8000 damage";
	}
		...
		s[2].explanation = "Use poison, 8000 damage.";
		s[3].name = "Clone Attack"; s[3].damage = 15000; s[3].healing = 0;
		s[3].explanation = "Theif's ultimate attack, summon clone to attack twice. 15000 damage";
	}
}
